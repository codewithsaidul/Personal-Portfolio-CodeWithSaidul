...
const Skill = ({ name, x, y }) => {
  return (
    ...
    >
      <h3 className="xs:text-[12px] text-xl">{name}</h3>
    </motion.div>
  );
};
...
const Skills = () => {
  return (
    <>
      ...
      <div
        className="w-full h-screen lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] relative flex items-center justify-center rounded-full bg-circularLight lg:bg-circularLightLg md:bg-circularLightMd sm:bg-circularLightSm dark:bg-circularDark lg:dark:bg-circularDarkLg md:dark:bg-circularDarkMd sm:dark:bg-circularDarkSm mt-20"
      ...
      >
        ...
        <Skill name="Bootstrap" x="10vw" y="-17vw" />
        <Skill name="Tailwind" x="0vw" y="13vw" />
        <Skill name="React JS" x="-25vw" y="10vw" />
        <Skill name="Next JS" x="32vw" y="13vw" />
        ...
        <Skill name="Node JS" x="-40vw" y="-5vw" />
      </div>
    </>
  );
};
